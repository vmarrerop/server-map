...
export const createPost = async (req, res) => {
  try {
    const { title, description, precio, precioCompra, unidad, cantidad, categoria, proveedor } = req.body;
    let image = null;
    if (req.files?.image) {
    ...
    const newPost = new Post({ title, description, image, precio, precioCompra, unidad, cantidad, categoria, proveedor});
    await newPost.save();
